...
ALL_CFLAGS   := -Wall -Wextra -Wpedantic -g -O3 $(GLOBAL_CFLAGS)   $(GLOBAL_CPPFLAGS) $(MODULE_CFLAGS)   $(MODULE_CPPFLAGS) $(CFLAGS)   $(CPPFLAGS) -I$(SRCDIR)/$(ARCH) -I$(SRCDIR)
ALL_CXXFLAGS := -Wall -Wextra -Wpedantic -g -O3 $(GLOBAL_CXXFLAGS) $(GLOBAL_CPPFLAGS) $(MODULE_CXXFLAGS) $(MODULE_CPPFLAGS) $(CXXFLAGS) $(CPPFLAGS) -I$(SRCDIR)/$(ARCH) -I$(SRCDIR)
ALL_LDFLAGS  := -Wall -Wextra -Wpedantic -g -O3 $(GLOBAL_LDFLAGS)  $(MODULE_LDFLAGS)  $(LDFLAGS)   
...
$(LIBRARY): $(OBJECTS) 
	...
	$(AR) -rc $@ $(OBJECTS)
	mkdir -p $(PROJECT_ROOT)/../sysroot-arm/usr/lib
	cp $@ $(PROJECT_ROOT)/../sysroot-arm/usr/lib
	cp $@ $(PROJECT_ROOT)/../sysroot-arm/usr/lib/libg.a
endif
